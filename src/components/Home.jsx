    ...
    >
      <div className="max-w-screen-lg mx-auto flex flex-col items-center justify-center h-full px-4 pl-8 md:flex-row overflow-hidden">
        <div className="flex mt-4 flex-col justify-center h-full ">
          <h3 className="animate__animated animate__fadeInLeft animate__delay-0.5s lg:mt-0 md:-mt-96 font-bold sm:text-2xl mt-10 text-white ">
            Hi' &nbsp; There <br />I am a&nbsp; full Stack Developer
          </h3>
          <p className="pl-4 mb-2 font-medium text-gray-300 py-4 max-w-md animate__animated animate__fadeInLeft animate__delay-1s">
          ...
          <div className="">
            <a
              ...
              rel="noreferrer"
            >
              <button className="bg-cyan-500 shadow-2xl shadow-cyan-900 text-white w-5/12 px-3 py-1 flex items-center rounded-md bg-gradient-to-l from-cyan-500 to-gray-900 cursor-pointer ">
