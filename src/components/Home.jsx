    ...
    >
      <div className="max-w-screen-lg mx-auto flex flex-col  items-center justify-center h-full px-4 pl-8 md:flex-row overflow-hidden">
        <div className="flex mt-4 flex-col justify-center  h-full">
          ...
          <p className="pl-4  mb-2 font-medium  text-gray-300 py-4 max-w-md">
          ...
          <div>
            ...
            >
              <button
                className="bg-cyan-500 shadow-2xl shadow-cyan-900  text-white w-5/12 px-3 py-1 flex items-center rounded-md bg-gradient-to-l from-cyan-500  to-gray-900 cursor-pointer 
              "
              >
