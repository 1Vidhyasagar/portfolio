      ...
      <div className="flex flex-col p-4 justify-center max-w-screen-lg mx-auto h-full">
        ...
        <div className="flex justify-center items-center">
          <form action="https://getform.io/f/5375b9de-f060-4863-8ebd-795c95998635"  method="post" className="flex flex-col w-full md:w-2/6 h-3/4">
            ...
            className="text-sm p-2 bg-transparent border-2 rounded-md text-white focis:outline-none"
            />
              <input
            type="text"
            name="email"
            placeholder="Enter your email"
            className="text-sm my-1 p-2 bg-transparent border-2 rounded-md text-white focis:outline-none"
            />
            <textarea 
            name="message"
            placeholder="Enter your message"
            rows="10"
            className="text-sm p-2 bg-transparent border-2 rounded-md text-white focus:outline-none"
            ></textarea>
